...
title: about
permalink: /
subtitle: Ph.D. Candidate at UIC | Research Intern at Microsoft
...
I'm Mahdi Erfanian, a Ph.D. candidate in Computer Science at the University of Illinois Chicago, where I am a member of the [IndexLab](https://www.cs.uic.edu/~indexlab/) under the supervision of [Dr. Abolfazl Asudeh](https://www.cs.uic.edu/~asudeh/). I received my M.S. in Computer Science from UIC (awarded en route to Ph.D.) and my B.Sc. in Computer Engineering from Sharif University of Technology. I am currently a Research Intern at **Microsoft** (Code|AI team), working on mitigating hallucination in LLMs and GenAI code agents. My research spans **LLMs**, **Multimodal Data Management**, **Generative AI**, **Algorithmic Fairness**, and **Foundation Models**.
